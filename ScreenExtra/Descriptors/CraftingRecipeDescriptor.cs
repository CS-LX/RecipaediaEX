...
namespace RecipaediaEX.Implementation {
    ...
    public class CraftingRecipeDescriptor : RecipeDescriptor {
		...
		public CraftingRecipeDescriptor(IRecipaediaRecipeNavigator navigator) : base(navigator) {
        ...
        public override void Show(IRecipe recipe, string nameSuffix) {
            ...
            foreach (Widget widget in m_gridWidget.Children) {
                ...
                string ingredient = craftingRecipe.Ingredients[widgetCell.X + (widgetCell.Y * 6)];
            ...
            m_resultWidget.SetResult(new BlockItem(BlocksManager.Blocks[Terrain.ExtractContents(craftingRecipe.ResultValue)], 0, craftingRecipe.ResultValue), m_navigator, craftingRecipe.ResultCount);
        }

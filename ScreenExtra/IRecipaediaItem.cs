namespace RecipaediaEX.UI {
    ...
    public interface IRecipaediaItem {
        ...
        /// </summary>
        string DetailScreenName { get; }

        /// <summary>
        /// 条目的配方界面的字符串名称，用于打开界面
        /// <para>【例】对于原版，此属性为 RecipaediaRecipes</para>
        /// </summary>
        string RecipeScreenName { get; }

        /// <summary>
        /// 查看配方按钮是否可按下
        /// </summary>
        bool RecipesButtonEnabled { get; }

        /// <summary>
        /// 查看配方按钮显示的文本
        /// </summary>
        string RecipesButtonText { get; }

        /// <summary>
        /// 查看详细信息按钮是否可按下
        /// </summary>
        bool DetailsButtonEnabled { get; }

        /// <summary>
        /// 查看详细信息按钮显示的文本
        /// </summary>
        string DetailsButtonText { get; }
    }
}
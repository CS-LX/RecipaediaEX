...
> **版本**：v0.20  
> **状态**：**Pre-release 发版前冲刺**（§9）；**P0-PR-01 / Track B / D24 / D25 已清偿**（2026-06-16）  
> **下一里程碑**：Track C 冒烟 + B4 发包  
...
**发包门槛**：P0 / Track B / **D24、D25 已清偿**（2026-06-16）；**Track C 冒烟 + B4** 后发 prerelease。

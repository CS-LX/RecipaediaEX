...
> **版本**：v0.27  
> **状态**：**preview8 已发** — REX `2.0.0.0-preview8`（2026-06-25）；W5 / Phase 4b 助手全局搜索已交付  
> **下一里程碑**：**W2 / W3**（Shift+ / 熔炉）；**W6 搁置**（见下）  
...
| **下一优先** | **W2** Shift 多组 `+` / **W3** 熔炉 Phase 2c；**勿做 W6** 直至正式版后新方案评审通过 |
...
**推荐实施顺序**：W1 → W4 → **W4.5**（快赢、可单独 `preview7` patch）→ W5 → ~~W6~~ → **W2/W3**（W6 搁置，见文首说明）。

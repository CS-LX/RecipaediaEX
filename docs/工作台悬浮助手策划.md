...
> **版本**：v0.13  
> **状态**：**Phase 1 已收尾**（2026-06-16）；**Phase 1.5 / 1.6 已收尾**；**Phase 2a 已收尾**；**Phase 2a.1 已收尾**；**Phase 2a.2 已收尾**；**Phase 2b 已收尾**；**TD-01 已清偿**（2026-06-16，流体 `IRecipaediaDescriptionItem` + 图鉴子屏 Esc 导航）  

...
> **版本**：v0.25  
> **状态**：**preview7 已发** — REX `2.0.0.0-preview7`（2026-06-25）；W1 / W4 / W4.5（Phase 4a + 4d）已交付  
> **下一里程碑**：**W5** Phase 4b 助手全局搜索 → **W6** 材料推荐；§1.2（酸菜小咸鱼 F6～F9）+ §1.3（洛贼 F12/F13 已在 4d 收口）  
...
| 项 | 说明 |
|----|------|
| **已发 REX** | `2.0.0.0-preview7`：+ W1 Hide、W4 生命周期/门控、W4.5 默认 All + 输入即搜；详见 [`CHANGELOG.md`](CHANGELOG.md) |
...
| **下一优先** | **W5** 助手全局搜索（D27 / F6）→ **W6** 打开即推荐 + 原料反查（D29/D30）→ **W2/W3** Shift+ / 熔炉 |

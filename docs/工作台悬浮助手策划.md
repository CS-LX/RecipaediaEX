...
> **版本**：v0.31  
> **状态**：**preview8 已发** — REX `2.0.0.0-preview8`（2026-06-25）；**W2 / W3 已交付**；W3 黑盒 US-C2c-01～05 **已通过**（待 preview9 发包）  
> **下一里程碑**：preview9 发包（W2+W3）；**W6 搁置**（见下）  
...
| 项 | 说明 |
|----|------|
| **已发 REX** | `2.0.0.0-preview8`：+ W5 助手全库搜索（D27）；详见 [`CHANGELOG.md`](CHANGELOG.md) |
...
| **下一优先** | **W3** 熔炼 Phase 2c（`FormattedGridPlacementPlanner` + `FurnacePlacementTarget` + 熔炉 Host）；**勿做 W6** 直至正式版后新方案评审通过 |
